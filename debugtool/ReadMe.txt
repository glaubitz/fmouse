========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : debugtool
========================================================================


Diese debugtool-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre debugtool-Anwendung bilden.
...
debugtool.h
	...
	Anwendungsklasse CDebugtoolApp.
...
res\debugtool.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei debugtool.rc eingebunden.
...
debugtoolDlg.h, debugtoolDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CDebugtoolDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in debugtool.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	debugtool.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
